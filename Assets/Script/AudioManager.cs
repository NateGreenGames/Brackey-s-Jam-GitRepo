...
public enum eSFX
{
    ...
    creatureFlee, eyeIntro, creatureSqueel, leverBump, crush, suffocation, hatchOpen, valvesqueek1, 
    valvesqueek2, valvesqueek3, plungerShock, plungerLockedIn, wormIntro, tentacleIntro, tentacleOutro, none
}
